...
const LoadingDemo: React.FC = () => {
  const [selectedVariant, setSelectedVariant] = useState<'linear' | 'circular' | 'dots' | 'spinner'>('linear');
      ...
      <Container maxWidth="lg" sx={{ mt: 10, pb: 6 }}>
        ...
        <Paper sx={{ p: 4, mb: 4 }}>
          ...
          <Box sx={{ mt: 4 }}>
            ...
            <Button
              variant="contained"
              onClick={() => progressSimulation.reset()}
              sx={{ mt: 2 }}
            >
              Restart Animation
            </Button>
        ...
        <Paper sx={{ p: 4, mb: 4 }}>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <Typography variant="h6" gutterBottom>Card Skeleton</Typography>
              <SkeletonLoader variant="card" animation="pulse" />
            </Grid>
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom>Image Skeleton</Typography>
            ...
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom>List Skeleton</Typography>
        ...
        <Paper sx={{ p: 4, mb: 4 }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Typography variant="h6" gutterBottom>With Shimmer Effect</Typography>
              <LazyImage
            ...
            <Grid item xs={12} md={6}>
              <Typography variant="h6" gutterBottom>With Placeholder</Typography>
              <LazyImage
