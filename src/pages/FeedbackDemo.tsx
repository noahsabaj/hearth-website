  ...
  return (
    <Container maxWidth="md" sx={{ mt: 10, mb: 6 }}>
      ...
      <Typography variant="body1" paragraph>
        This page demonstrates the feedback widget system implemented for Hearth Engine documentation.
        Each section can collect user feedback with thumbs up/down voting and optional comments.
      </Typography>
